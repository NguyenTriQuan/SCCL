...
class Appr(object):
    ...
    def __init__(self,model,nepochs=100,sbatch=256,lr=0.001,lr_min=1e-6,lr_factor=3,lr_patience=5,clipgrad=100,args=None, log_name=None, split=False):
        ...
        self.log_name = '{}_{}_{}_{}_lamb_{}_mul_{}_lr_{}_batch_{}_epoch_{}'.format(args.date, args.experiment, args.approach,args.seed,
...
#                             break
        ...
        self.fisher=utils.fisher_matrix_diag(t,xtrain,ytrain,self.model,self.criterion, split = self.split, args=args)
        if t>0:
