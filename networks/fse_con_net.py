...
from layers.fse_con_layer import DynamicLinear, DynamicConv2D, _DynamicLayer, DynamicClassifier
...
class MLP(_DynamicModel):
    ...
    def __init__(self, input_size, mul=1, norm_type=None):
        ...
        self.layers = nn.ModuleList([
            ...
            nn.ReLU(),
            DynamicClassifier(N, args.feat_dim, bias=True),
            ])
...
class VGG8(_DynamicModel):
    ...
    def __init__(self, input_size, mul=1, norm_type=None, bias=True):
        ...
        self.layers += nn.ModuleList([
            ...
            nn.ReLU(),
            # nn.Dropout(0.5),
            DynamicClassifier(256, args.feat_dim, last_layer=True)
            ])
